...
$('#save').onclick = async () => {
  try {
    collect(); store.config.whatsappPhone = $('#phone').value.trim(); store.config.instagramUrl = $('#instagram').value.trim() || '#'; store.config.facebookUrl = $('#facebook').value.trim() || '#'; store.config.deliveryNote = $('#delivery').value.trim(); store.config.localAddress = $('#localAddress').value.trim(); store.config.localHours = $('#localHours').value.trim(); store.config.pickupText = $('#pickupText').value.trim();
